...
/* Class BetterClassConstructor
 * Purpose: this class is an advancement of the class
 * BetterClassValidate by adding mutators and private member variables,
 ...
 * the given values for the date are valid or not. It also has proper constructors
 * to utilize rather than setting each member variable as previously done.
 */
public class BetterClassConstructor { //start class

	private String month;
	private int day;
	private int year;

	//default constructor, default values for each member variable are given
	public BetterClassConstructor(){ //start constructor
	...
	/*BetterClassConstrictor Constructor
	 * Purpose: assigns given values for each member variables
	 * utilizing a constructor instead of using the mutators in
	 * a main method as previously done.
	 * Parameters: String month, int year, int day
	 * Returns: nothing
	 */
	public BetterClassConstructor(String month, int year, int day){ //start constructor
